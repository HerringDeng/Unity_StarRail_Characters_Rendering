...
half4 Frag(Varyings input) : SV_Target
{
    ...
    // 脸部
        ...
        half faceMap_a = SAMPLE_TEXTURE2D(_LightMapTex, sampler_LightMapTex, sdfUV).a; //脸部的lighmap的a通道存储脸部sdf光照阴影
    ...
    // 最终输出颜色
    half3 albedo = diffuseColor + diffuseColor*environmentColor * _EnvironmentIntensity; //基础色
